...
{{ csrf_field() }}
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" name="regestration_id" id="regestration_id" placeholder="Registration_NO" value="{{$student->regestration_id}}">
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="department_name" id="department_name" placeholder="Department Name"  value="{{$student->department_name}}">
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      <textarea class="form-control" name="text" id="text" rows="10"> {!!$student->text!!} </textarea>
    </div>
  </div>
